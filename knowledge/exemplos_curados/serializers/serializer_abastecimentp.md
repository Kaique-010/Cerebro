---
title: Serializer  de Abastecimento
type: exemplo_codigo
layer: serializer
style: rest
priority: 10
tags: ["serializer", "django", "abastecimento", "multitenant", "regra_negocio"]
uses_db_alias: true
uses_slug: true
uses_serializer: false
uses_form: false
related_entities: ["Abastecusto", "Bombas"]
