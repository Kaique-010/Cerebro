---
title: AutoCompletes de exemplo
type: exemplo_codigo
layer: autocompletes
style: rest
priority: 10
tags: ["autocomplete", "django", "abastecimento", "multitenant", "regra_negocio"]
uses_db_alias: true
uses_slug: true
uses_serializer: false
uses_form: false
related_entities: ["Entidades", "Bombas", "Veiculos", "Marca", "Produtos", "Centrodecustos"]
reason: 'Bom exemplo de autocomplete com regra concentrada, parâmetros explícitos e suporte multi-tenant.'
---

# AutoCompletes de exemplo

## Por que este exemplo é bom

- retorna dados formatados
- simplifica nomes de models legados
- valida estado do objeto
