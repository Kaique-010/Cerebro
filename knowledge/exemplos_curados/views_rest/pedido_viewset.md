---
## Exemplo de view REST

### `knowledge/exemplos_curados/views_rest/pedido_viewset.md`
---

title: Pedido ViewSet Bom
type: exemplo_codigo
layer: view_rest
style: rest
priority: 10
tags: ["view_rest", "drf", "django", "pedido", "api"]
uses_db_alias: true
uses_slug: true
uses_serializer: true
uses_form: false
related_entities: ["PedidoVenda"]
reason: "Bom exemplo de ViewSet fina com serializer e chamada de service."
