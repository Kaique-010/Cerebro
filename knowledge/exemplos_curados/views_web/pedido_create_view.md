...
### `knowledge/exemplos_curados/views_web/pedido_create_view.md`

```md
---

title: Pedido CreateView Boa
type: exemplo_codigo
layer: view_web
style: web
priority: 10
tags: ["view_web", "cbv", "django", "pedido", "form"]
uses_db_alias: true
uses_slug: true
uses_serializer: false
uses_form: true
related_entities: ["PedidoVenda"]
reason: "Bom exemplo de CBV web com form e service desacoplado."
...
- usa form
- respeita fluxo web
- mantém regra fora da view
- integra contexto multi-tenant
