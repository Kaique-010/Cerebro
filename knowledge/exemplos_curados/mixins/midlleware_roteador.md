title: Middleware Principal do sistema de roteamento
type: exemplo_codigo
layer: mixins
style: rest
priority: 10
tags: ["mixins", "django", "pedido", "multitenant", "regra_negocio"]
uses_db_alias: true
uses_slug: true
uses_serializer: false
uses_form: false
related_entities: ["PedidoVenda", "ItensPedidoVenda"]
reason: 'Bom exemplo de middleware com regra concentrada, parâmetros explícitos e suporte multi-tenant.'
