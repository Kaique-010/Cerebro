---
title: Util Principal do sistema de roteamento
type: exemplo_codigo
layer: utils
style: rest
priority: 10
tags: ["utils", "django", "pedido", "multitenant", "regra_negocio"]
uses_db_alias: true
uses_slug: true
uses_serializer: false
uses_form: false
related_entities: ["PedidoVenda", "ItensPedidoVenda"]
reason: 'Bom exemplo de service com regra concentrada, parâmetros explícitos e suporte multi-tenant.'
---

# UtilsDBFromSlug

## Por que este exemplo é bom

- tem uma função crucial
- facilita a rotação de bancos
- simplifica a consulta de objetos
- evita duplicação de código
- é reutilizável em diferentes partes do sistema
- é testável
- é aderente ao padrão multi-tenant
